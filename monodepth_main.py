...
parser.add_argument('--filled_disparity_loss_weight',   type=float, help='filled disparity weight', default=0.1)
...
def main(_):
    ...
    params = monodepth_parameters(
        ...
        filled_disparity_loss_weight=args.filled_disparity_loss_weight,
